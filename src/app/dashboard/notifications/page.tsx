...
const mockNotifications: Notification[] = [
  { id: "1", type: "group_invite", title: "Mukando Invite", message: "You've been invited to join 'Harare Sunshine Savers'.", timestamp: new Date(Date.now() - 3600000).toISOString(), read: false },
  { id: "2", type: "success", title: "Contribution Confirmed", message: "Your ZWL 500 contribution to 'Business Boosters' was successful.", timestamp: new Date(Date.now() - 86400000 * 1).toISOString(), read: false },
  { id: "3", type: "warning", title: "Policy Renewal Due", message: "Your Basic Health Cover renews in 7 days. Ensure sufficient funds.", timestamp: new Date(Date.now() - 86400000 * 2).toISOString(), read: true },
  ...
  { id: "5", type: "error", title: "Failed Transaction", message: "Your transfer of ZWL 250 to J. Moyo failed. Please try again.", timestamp: new Date(Date.now() - 86400000 * 0.5).toISOString(), read: false },
];
